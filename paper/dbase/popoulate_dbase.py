...
if __name__ == '__main__':
    # print(Session() & 'experiment_name="TwoAndahalf Maze"')
    print((Session * Tracking & 'experiment_name="TwoAndahalf Maze"').fetch())
    # print((Session * Tracking).fetch())

    # print((Session * Tracking & 'experiment_name="TwoAndahalf Maze"').fetch())
    # print(Trials * Session & 'experiment_name="Revision1"')
    ...
    p.tracking.populate(display_progress=True, suppress_errors=False, return_exception_objects =True) # ! tracking data
